        ...
        <main className="text-[#f9f7f7] mt-12 ml-8 mr-8 md:ml-28 md:mr-28">
            ...
            <div className='h-auto flex-col justify-center items-center'>
                ...
                <div className='sm:ml-8 sm:mr-8 md:ml-32 md:mr-32'>
                    <h1 className='text-center text-xl font-bold'>Competition</h1>
            ...
            <div className='h-auto flex-col justify-center items-center'>
                ...
                <div className='sm:ml-8 sm:mr-8 md:ml-32 md:mr-32'>
                    <h1 className='text-center text-xl font-bold'>Grand Opening & Seminar Nasional</h1>
            ...
            <div className='h-auto flex-col justify-center items-center'>
                ...
                <div className='sm:ml-8 sm:mr-8 md:ml-32 md:mr-32'>
                    <h1 className='text-center text-xl font-bold'>Donor Darah</h1>
            ...
            <div className='h-auto flex-col justify-center items-center'>
                ...
                <div className='sm:ml-8 sm:mr-8 md:ml-32 md:mr-32'>
                    <h1 className='text-center text-xl font-bold'>Grand Closing</h1>
